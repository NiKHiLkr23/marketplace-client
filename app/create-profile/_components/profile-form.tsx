...
export function ProfileForm() {
  ...
  const onClick = useCallback(
    async (data: ProfileFormValues) => {
      ...
      const newEmployeeUserPDA = PublicKey.findProgramAddressSync(
        [Buffer.from("User"), publicKey.toBuffer()],
        marketplaceProgramId
      )[0];
      console.log(`new user PDA : ${newEmployeeUserPDA}`);
      ...
      const userPDA = await program.methods
        ...
        .accounts({
          user: publicKey,
          userProfile: newEmployeeUserPDA,
    ...
    [connection, publicKey, wallet, sendTransaction, router]
  );
